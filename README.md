...
> Mobile Auth Service: Mobile authentication backend with JWT, OAuth, and biometrics
...
git clone https://github.com/elitsuri/mobile-auth-service
cd mobile-auth-service
